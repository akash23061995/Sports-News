...
public class FragmentVideo extends Fragment implements RecyclerViewAdapter.ListItemClickListener  {
   View v;
   String link;
    ...
    private void read_from_realm() {
        mRealm.executeTransaction(new Realm.Transaction() {
            ...
            public void execute(Realm realm) {
                ...
                RealmResults<News> results = realm.where(News.class).equalTo("type", "video").findAll();;
                newsArrayList.clear();
